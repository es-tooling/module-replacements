---
description: cross-fetch was created at a time node didn't support fetch and it was useful to have the same API in browser and server,etc. It has still millions of downloads even if fetch since 18 ( experimental ) and 21 ( stable ) supports fetch API
---

# Replacements for `cross-fetch`
