---
description: Modern alternatives to remark-import for composing markdown files together
---

# Replacements for `remark-import`

## `@it-service-npm/remark-include`

[`@it-service-npm/remark-include`](https://github.com/IT-Service-NPM/remark-include) is a more actively maintained and feature-rich alternative to [`remark-import`](https://github.com/BrekiTomasson/remark-import).
