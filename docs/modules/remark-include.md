---
description: Modern alternatives to remark-include for composing markdown files together
---

# Replacements for `remark-include`

## `@it-service-npm/remark-include`

[`@it-service-npm/remark-include`](https://github.com/IT-Service-NPM/remark-include) is a more actively maintained and feature-rich alternative to [`remark-include`](https://github.com/Qard/remark-include).
